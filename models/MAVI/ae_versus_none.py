...
def ae_versus_none(modality: str, x_train, x_test, y_train, y_test): 
    ...
    for LATENT_DIM in LATENT_DIMS:
        ...
        plt.clf()
        um.plot_confusion(model_simple, x_test, y_test, filepath = os.path.join(OUTPUT_PLOTS, modality, f'CM_NO_REDUCTION_MODEL_{LATENT_DIM}dim.png'))
        plt.clf()
...
ae_versus_none('transcriptomic', x_train, x_test, y_train, y_test)
...
y_test = data_testing["vital_status_Dead"].astype(int)
x_train, y_train = ros.fit_resample(x_train_raw, y_train_raw)
ae_versus_none('cnv',  x_train, x_test, y_train, y_test)
...
y_test = data_testing["vital_status_Dead"].astype(int)
x_train, y_train = ros.fit_resample(x_train_raw, y_train_raw)
ae_versus_none('epigenomic',  x_train, x_test, y_train, y_test)
